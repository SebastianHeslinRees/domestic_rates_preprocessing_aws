...
def handler(event, context):
    ...
    input_path = event.get("input_path")  # e.g., s3://bucket/population_mid_year_estimates/ons_data/cleaned_data/
    output_path = event.get("output_path")  # e.g., s3://bucket/population_mid_year_estimates/ons_data/cleaned_data_combined/cleaned_data_combined.parquet
