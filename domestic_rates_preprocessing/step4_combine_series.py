...
S3_NEW_SERIES_PATH = "population_mid_year_estimates/ons_data/cleaned_data_combined/cleaned_data_combined.csv"
OUTPUT_PARQUET_PREFIX = "population_mid_year_estimates/ons_data/clean_old_and_new_combined_series.parquet"
TMP_DIR = "/tmp"
